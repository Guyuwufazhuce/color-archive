...
export default function Home() {
  ...
  // Group images by their effective category
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <header className="sticky top-0 z-10 bg-[#f8f9fa]/80 backdrop-blur-md border-b border-gray-200">
          ...
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Sort your images by color automatically.
              </p>
            </div>
        ...
        {totalCount > 0 && (
          <>
            ...
            <section>
              ...
              {activeFilter !== "all" &&
                (groupedImages.get(activeFilter)?.length ?? 0) === 0 && (
